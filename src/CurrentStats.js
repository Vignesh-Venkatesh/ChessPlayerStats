...
function CurrentStats({ playerName, selectedOption }) {
              ...
              <>
                <div className="statTile">
                  <div className="stats">
                    ...
                    <p className="rating">{stats.chess_rapid?.last?.rating || "N/A"}</p>
                    <p className="w-r-l">
                ...
                <div className="statTile">
                  <div className="stats">
                    ...
                    <p className="rating">{stats.chess_blitz?.last?.rating || "N/A"}</p>
                    <p className="w-r-l">
                ...
                <div className="statTile">
                  <div className="stats">
                    ...
                    <p className="rating">{stats.chess_bullet?.last?.rating || "N/A"}</p>
                    <p className="w-r-l">
